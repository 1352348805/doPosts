        ...
        $.post("${pageContext.request.contextPath}/postCategory?action=getBarByName",{className:seach},function(result){
          ...
          for(var i=0;i<date.length;i++){
            ...
            table+="<div class='col-md-4 col-sm-6 probootstrap-animate fadeInUp probootstrap-animated'><div class='probootstrap-block-image'>"+
                    "<div class='text'><h3 style=\"text-align: center\" class='mb30'><a href='${pageContext.request.contextPath}/user?action=postpage&secondId="+date[i].classId+"&postname=${date[i].className}'>"+date[i].className+"</a></h3>"+
                    "<p class='dark' style='text-align: center;''>"+date[i].classDescribe+"</p><hr>"+
                    "<p class='clearfix like'><a class='pull-left' href='#'><i class='fa fa-heart'></i></a><a class='pull-right' href='${pageContext.request.contextPath}/user?action=postpage&secondId="+date[i].classId+"&postname=${date[i].className}'><i class='fa fa-bars'></i></a></p>"+
                    "</div></div></div>";
          }
          $(".bar").html(table);
        },'json');
