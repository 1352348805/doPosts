...
<body> 
	...
	<div class="container">
		<div class="banner-menu">
		 ...
		 <ul class="menu">
		<li class="item1"><a href="#">Curabitur sapien<img class="arrow-img" src="<%=path%>/static/images/forumpark/arrow1.png" alt=""/> </a>
			<ul class="cute">
		...
		<li class="item2"><a href="#">Dignissim purus <img class="arrow-img " src="<%=path%>/static/images/forumpark/arrow1.png" alt=""/></a>
			<ul class="cute">
				<li class="subitem1"><a href="product.html">Cute Kittens </a></li>
				<li class="subitem2"><a href="product.html">Strange Stuff </a></li>
				<li class="subitem3"><a href="product.html">Automatic Fails </a></li>
		...
		<li class="item3"><a href="#">Ultrices id du<img class="arrow-img img-arrow" src="<%=path%>/static/images/forumpark/arrow1.png" alt=""/> </a>
			<ul class="cute">
				<li class="subitem1"><a href="product.html">Cute Kittens </a></li>
				<li class="subitem2"><a href="product.html">Strange Stuff </a></li>
				<li class="subitem3"><a href="product.html">Automatic Fails</a></li>
		...
		<li class="item4"><a href="#">Cras iacaus rhone <img class="arrow-img img-left-arrow" src="<%=path%>/static/images/forumpark/arrow1.png" alt=""/></a>
			<ul class="cute">
				<li class="subitem1"><a href="product.html">Cute Kittens </a></li>
				<li class="subitem2"><a href="product.html">Strange Stuff </a></li>
				<li class="subitem3"><a href="product.html">Automatic Fails </a></li>
